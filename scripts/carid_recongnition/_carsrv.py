...
"""autogenerated by genpy from license_plate_recognition/carsrvRequest.msg. Do not edit."""
import sys
...
class carsrvRequest(genpy.Message):
  _md5sum = "a4f08f997368f6320b328191e86b1a13"
  _type = "license_plate_recognition/carsrvRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(carsrvRequest, self).__init__(*args, **kwds)
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from license_plate_recognition/carsrvResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class carsrvResponse(genpy.Message):
  _md5sum = "1614737433aec2b9e816b3eabddd985c"
  _type = "license_plate_recognition/carsrvResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string carid
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(carsrvResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.carid = str[start:end].decode('utf-8')
      else:
        self.carid = str[start:end]
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
def _get_struct_I():
    ...
    return _struct_I
class carsrv(object):
  _type          = 'license_plate_recognition/carsrv'
  _md5sum = 'b7691f9a2ac1116e51294c14c779514b'
  _request_class  = carsrvRequest
  _response_class = carsrvResponse
